$(document).ready(function() {
  ...
  var APIKey = "35e4fbefae7e2295169cbe383b21243c";
  var units = "imperial";
  ...
  function displayCurrentWeather(data) {
    ...
    $("#temperature").text(`${Math.round(parseInt(data.current.main.temp) - 32 * (5/9))} °C`);
  ...
  function displayForecast(data) {
    ...
    $.each(forecast, function(i, day) {
      ...
      $(`#day-${i + 1}-temp`).text(`${Math.round(parseInt(day.main.temp)-32 * (5/9))} °C `);
